...
что-то.[mp3|мп3] - случайная аудиозапись из поиска 
...
За постоянные хуи на стенке, а так же поиск запрещенных материалов буду наказывать. Если долго не отвечаю, то или вы мне не нравитесь или вас слишком много. 
Пожелания и предложения, ад содом и рыбу принимаю в комментарии.
'''
